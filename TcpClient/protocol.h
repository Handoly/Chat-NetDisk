...
#define UNKNOW_ERROR "unknow errot!"
...
#define DELETE_DIR_FIALED "delete dir failed: is regular file!"

#define RENAME_FILE_OK "rename file successful!"
...
#define DELETE_FILE_FIALED "delete file failed: is dir!"

#define MOVE_FILE_OK    "move file ok!"
#define MOVE_FILE_FIALED    "move file failed: is regular file!"
...
enum ENUM_MSG_TYPE
{
    ...
    ENUM_MSG_TYPE_SHARE_FILE_NOTICE,       //共享文件通知
    ENUM_MSG_TYPE_SHARE_FILE_NOTICE_RESPOND,       //共享文件通知回复
